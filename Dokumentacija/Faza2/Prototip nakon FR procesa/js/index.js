...
function checkLogin() {
    $(document).ready(function () {
        ...
        } else if (password == localStorage.getItem("username#" + username)) {
...
function reserveRoom() {
    $(document).ready(function () {
        var date = $("#validationDefaultDateFrom").val();
        var time = $("#validationDefaultDateTo").val();
        var pets = $("#validationDefaultPets").val();
        var phone = $("#validationDefaultPhone").val();

        if (date == "") {
            alert("Morate uneti datum od");
        } else if (time == "") {
            alert("Morate uneti datum do");
        }
        else if (pets == "" || pets <= 0) {
            alert("Morate uneti broj ljubimaca");
        }
...
function input(par1, par2, par3) {
    $(document).ready(function () {
        ...
        if (a1 == "" || a2 == "" || a3 == "" || img == "") {
            ...
            alert("Uspešno ste uneli podatak");
        }
    });
}

function itemsInput(par1, par2, par3) {
    $(document).ready(function () {
        var a1 = $("#" + par1).val();
        var a2 = $("#" + par2).val();
        var a3 = $("#" + par3).val();
        ...
        if (a1 == "" || a2 == "" || a3 == "" || img == "") {
            ...
            alert("Morate uneti pozitivan broj za cenu");
        } else if (a3 <= 0) {
            alert("Morate uneti pozitivan broj za količinu");
        } else {
